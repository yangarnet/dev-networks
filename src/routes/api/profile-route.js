...
const profileRoute = () => {
    ...
    profileRouter.post(
        "/experience",
        passport.authenticate(process.env.AUTH_TYPE, { session: false }),
        profileController.addExperienceForProfile
    );
    profileRouter.put(
        "/experience/:exp_id",
        passport.authenticate(process.env.AUTH_TYPE, { session: false }),
        profileController.updateExperienceForProfile
    );
    profileRouter.delete(
        "/experience/:exp_id",
        passport.authenticate(process.env.AUTH_TYPE, { session: false }),
    ...
    profileRouter.post(
        "/education",
        passport.authenticate(process.env.AUTH_TYPE, { session: false }),
        profileController.addEducationForProfile
    );
    profileRouter.put(
        "/education/:edu_id",
        passport.authenticate(process.env.AUTH_TYPE, { session: false }),
        profileController.updateEducationForProfile
    );
    profileRouter.delete(
        "/education/:edu_id",
        passport.authenticate(process.env.AUTH_TYPE, { session: false }),
