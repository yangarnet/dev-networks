            ...
            request(server)
                ...
                .expect(res => {
                    ...
                    expect(res.body).to.have.property(
                        "msg",
                        "Error: email john.doe@gmail.com already registered"
                    );
                    done();
                })
                .catch(err => done(err));
        ...
        it("should login the user with correct details", done => {
            ...
            request(server)
                ...
                .expect(response => {
                    ...
                    expect(response.body.token).to.contain(
                        "Bearer",
            ...
            .end(() => {
                ...
                request(server)
                    ...
                    .end((err, response) => {
                        ...
                        expect(response.body.skills)
                            .to.be.a("array")
                            .with.lengthOf(3);
                        expect(response.body.experiences)
                            .to.be.a("array")
                            .with.lengthOf(0);
                        expect(response.body.education)
                            .to.be.a("array")
                            .with.lengthOf(0);
                        expect(response.body.user).to.be.not.null;
                        ...
                        profile
                            ...
                            .then(result => {
                                ...
                                expect(result)
                                    .to.be.a("array")
                                    .with.lengthOf(1);
                                expect(result[0].handle).to.be.equal(
                                    "John Kelly"
                                );
                                expect(result[0].status).to.be.equal(
                                    "developer"
                                );
                                expect(result[0].bio).to.be.equal("male");
                                expect(result[0].skills)
                                    .to.be.a("array")
                                    .with.lengthOf(3);
                                expect(result[0].experiences)
                                    .to.be.a("array")
                                    .with.lengthOf(0);
                                expect(result[0].education)
                                    .to.be.a("array")
                                    .with.lengthOf(0);
                                done();
                            })
